...
export default function Deadline({ isDeadline, setIsDeadline, setDate, setTime, setDeadlineType }:
  { isDeadline: boolean, setIsDeadline: (isDeadline: boolean) => void, setDate: (date: string) => void, setTime: (time: string) => void, setDeadlineType: (deadlineType: string) => void }) {
