  ...
  if (windowSize.width! < 1024) {
    return <div className="flex flex-col items-center">
      <div className='w-11/12 '>
        <Image priority className='animate-tinyBounce w-auto' loading='eager' src="/todos.png" width="500" height="100" alt="todos" />
      </div>
    ...
    return <div className='flex justify-around'>
      <div className='w-7/12 lg:w-10/12 flex justify-center'>
        <Image priority className='animate-tinyBounce w-auto' loading='eager' src="/todos.png" width="700" height="700" alt="todos" />
      </div>
